    ...
    <div class="container">
        <div class="shadow">
            <h3><spring:message code="meals.title"/></h3>
                ...
                <form id="filter" role="form" class="form-horizontal" action="/meals" method="get">
                    <div class="form-group">
                        <label for="startDate" class="control-label col-sm-2"><spring:message
                    ...
                    <div class="form-group">
                        <label for="endDate" class="control-label col-sm-2"><spring:message
                    ...
                    <div class="form-group">
                        <label for="endTime" class="control-label col-sm-2"><spring:message
                ...
                <a class="btn btn-sm btn-info " onclick="updateTable()">
                    <spring:message code="meals.filter"/>
                    <span class="glyphicon glyphicon-filter" aria-hidden="true"></span>
                </a>

                <a class="btn btn-sm btn-info" onclick="add()">
                    <spring:message code="meals.add"/>
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                </a>

                <a class="btn btn-sm btn-info pull-right" onclick="window.location ='meals'">
                    Очиcтить фильтр
                </a><br><br>
